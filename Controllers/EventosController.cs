...
namespace Simbora.Controllers
{
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Data,Horario,Local,Degraca")] Eventos eventos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Data,Horario,Local,Degraca")] Eventos eventos)
        {
            if (id != eventos.Id)
            {
                return NotFound();
